...
use super::response_types::{
    bet::UserBetResponse, claimable_fees::ClaimableFeesResponse, contest_data::ContestDataResponse, contest_data_list::ContestDataListResponse, fee_percent::FeePercentResponse, get_snip20::GetSnip20Response, minimum_bet::MinimumBetResponse, total_value::TotalValueResponse, users_bets::UsersBetsResponse
};
