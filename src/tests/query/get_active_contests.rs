...
mod tests {
    ...
    use crate::{
        ...
        tests::{
            constants::{
                ...
                AFTER_TIME_OF_4_CLOSE, AFTER_TIME_OF_CLOSE, AFTER_TIME_OF_RESOLVE,
            },
    ...
    fn get_page_num_1_page_size_2() {
        ...
        test_env.get_contests_success(Some(1), Some(2), None, Some(ContestQueryFilter::Active), 0);
    }
    ...
    fn get_page_sort_by_time_of_close() {
        ...
        test_env.get_contests_success(None, None, Some(ContestQuerySortOrder::Descending), None, 5);
    }
