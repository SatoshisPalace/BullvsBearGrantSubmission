...
mod tests {
    ...
    fn total_number_with_no_contests() {
        ...
        test_env.get_number_of_contests(None);
    }
    ...
    fn total_number_with_one_contest() {
        ...
        test_env.get_number_of_contests(Some(&1));
    }
    ...
    fn functions_properly_with_many_contests() {
        ...
        test_env.get_number_of_contests(Some(&2));
        ...
        test_env.get_number_of_contests(Some(&3));
        ...
        test_env.get_number_of_contests(Some(&5));
        ...
        test_env.get_number_of_contests(Some(&8));
        ...
        test_env.get_number_of_contests(Some(&10));

        contest_file = 11;
        test_env.first_bet_on_contest_success(&contest_file, &1, &100);
        test_env.set_time(AFTER_TIME_OF_11_CLOSE);
        test_env.get_number_of_contests(Some(&11));

        contest_file = 12;
        test_env.first_bet_on_contest_success(&contest_file, &1, &100);
        test_env.set_time(AFTER_TIME_OF_RESOLVE);
        test_env.get_number_of_contests(Some(&12));
    }
}
